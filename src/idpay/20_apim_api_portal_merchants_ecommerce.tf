...
module "idpay_itn_portal_merchants_ecommerce_api" {
  ...
  api_operation_policies = [
    ...
    },
    {
      ...
      xml_content = templatefile("./apim/api/idpay_merchants_ecommerce/put-invoice-update-transactions-policy.xml.tpl", {
        ingress_load_balancer_hostname = local.domain_aks_ingress_hostname
      })
    },
    {
    ...
    },
    {
      ...
      xml_content = templatefile("./apim/api/idpay_merchants_ecommerce/post-reversal-invoiced-payment-policy.xml.tpl", {
        ingress_load_balancer_hostname = local.domain_aks_ingress_hostname
      })
    },
    {
