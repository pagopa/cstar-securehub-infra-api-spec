...
paths:
  ...
  '/support':
    post:
      tags:
        - support
      summary: 'ENG: Build a Zendesk JWT and return redirect URL - IT: Genera un JWT per Zendesk e restituisce la URL di redirect'
      description: >
        ENG: Generates a JWT token for Zendesk SSO based on user data.
        IT: Genera un token JWT per SSO Zendesk a partire dai dati utente.
      ...
      requestBody:
        required: true
        description: 'ENG: User data for JWT creation - IT: Dati utente per la creazione del JWT'
        content:
          application/json:
            schema:
