...
module "idpay_itn_merchants_portal" {
  ...
  api_operation_policies = [
    ...
    },
    {
      ...
      xml_content = templatefile("./apim/api/idpay_merchants_portal/get-reward-batch-by-id-policy.xml.tpl", {
        ingress_load_balancer_hostname = local.domain_aks_ingress_hostname
      })
    },
    {
    ...
    },
    {
      ...
      xml_content = templatefile("./apim/api/idpay_merchants_portal/post-reversal-invoiced-payment-policy.xml.tpl", {
        ingress_load_balancer_hostname = local.domain_aks_ingress_hostname
      })
    }
  ]
